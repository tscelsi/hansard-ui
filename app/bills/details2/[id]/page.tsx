        ...
        <div className="card">
          <Link
            ...
            className={clsx(
              ...
              "text-link-blue text-sm hover:underline"
            )}
          >
            Home
          </Link>
    ...
    <div className="container">
      ...
      <div className="flex flex-col gap-2 px-2 py-3 border-b border-dark-grey">
        ...
        <p
          className={clsx("text-sm text-light-grey", instrumentSans.className)}
        >
          Speech counts over the last 18 days, as well as any time speeches were
          given during the lifetime of the bill.
        </p>
      </div>
      <div className="flex flex-col gap-2 px-2 py-3 border-b border-dark-grey">
            ...
            >
              ...
              >
                <span>
                  ...
                  (x-axis) is a number between -1 and 1. It measures support
                  toward the bill under discussion. Complete support receives a
                  value of 1 and being completely against -1.
                </span>
                ...
                <span>
                  ...
                  (y-axis) is a number between 0 and 1. It is a measure of the
                  positive language used in speeches. Very positive language is
                  scored 1 and very negative and aggressive language is scored
                  0.
                </span>
                <span className="text-light-grey">
                  <strong>NOTE:</strong> The textual analysis that provides
                  these scores was generated by an LLM, and is currently only
                  supported for speeches in the house of representatives.
                </span>
              </p>
            </Tooltip>
          </div>
      ...
      <div className="flex flex-col gap-2 px-2 py-3 border-b border-dark-grey">
        ...
        <Accordion
          items={speechListResult.map((el) => ({
            ...
            content: (
              <div key={el._id.toISOString()} className="">
                <RadixAccordion.Root type="multiple">
                  <ol className="text-md flex flex-col">
                    {el.parts.map((p) => {
                      if (p.type === "speech") {
                        ...
                        return (
                          <RadixAccordion.Item
                            key={p.id}
                            value={String(p.speech_seq)}
                          >
                            <li key={p.speech_seq}>
                              <section
                                id={`${p.speech_seq}`}
                                className="flex flex-col gap-2 border-b border-dark-grey py-2"
                              >
                                    ...
                                    <div className="flex flex-col justify-center w-full gap-1">
                                      <div className="flex items-center gap-1 mr-1">
                                        ...
                                        <div className="flex gap-2 items-center justify-between">
                                          ...
                                          <ChevronDown12Filled className="transition-transform duration-200" />
                                        </div>
                                      </div>
                                ...
                                <RadixAccordion.Content>
                                  <div
                                    className={clsx(
                                      "tracking-wide whitespace-pre-wrap"
                                    )}
                                  >
